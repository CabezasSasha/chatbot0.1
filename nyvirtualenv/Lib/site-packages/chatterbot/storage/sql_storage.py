...
from classdirectory import SQLStorageAdapter

database_uri = 'sqlite:///my_database.db'
storage_adapter = SQLStorageAdapter(database_uri=database_uri)

chatbot = ChatBot('My ChatBot', storage_adapter=storage_adapter)
